...
local function FormatTimerError(msg)
...
function Timers:Think()
  ...
  for k,v in pairs(Timers.timers) do
    ...
    if now >= v.endTime then
      ...
      if v.context then
        status, nextCall = xpcall(function() return v.callback(v.context, v) end, FormatTimerError)
      else
        status, nextCall = xpcall(function() return v.callback(v) end, FormatTimerError)
      end
